...
<section className="w-full py-20 ">
    ...
    <div className="my-20 flex flex-col lg:flex-row items-center justify-center bg-white gap-4 dark:bg-black w-full mx-auto px-8">
    <Card
...
>
    ...
    <div className="text-center group-hover/canvas-card:-translate-y-4   absolute top-[50%] left-[50%] transalte-x-[-50%] transalte-y-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
        {icon}
    </div>
